package com.devrep.libdocto.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.devrep.libdocto.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.devrep.libdocto.security.DomainUserDetailsService", "createSpringSecurityUser");
